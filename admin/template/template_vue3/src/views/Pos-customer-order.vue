...
<template>
	<!-- BEGIN pos -->
	<div class="pos pos-with-menu pos-with-sidebar" v-bind:class="{ 'pos-sidebar-mobile-toggled': mobileSidebarToggled }">
						...
						<ul class="nav nav-tabs">
							<li class="nav-item" v-for="category in menu.category">
								<a class="nav-link" v-bind:class="{'active': category.active }" href="#" v-on:click="(event) => showType(event, category.type)">
									<div class="nav-icon"><i v-bind:class="category.icon"></i></div>
				...
				<div class="pos-content-container h-100">
					<div class="product-row">
						<template v-for="food in menu.food">
							<div class="product-container" v-if="!food.hide">
								<a href="#" class="product" v-bind:class="{ 'not-available': !food.available }" v-on:click="(event) => showFoodModal(event, food.id)">
				...
				<div class="h-100 d-flex flex-column p-0">
					...
					<perfect-scrollbar ref="posSidebarBody" class="pos-sidebar-body tab-content">
						...
						<div class="tab-pane fade h-100 show active" id="newOrderTab">
							...
							<!-- BEGIN pos-table -->
							<div class="pos-table" v-if="order.length > 0">
								<div class="row pos-table-row" v-for="order in order">
									<div class="col-9">
											...
											<div class="info">
												...
												<div class="input-group qty">
													<div class="input-group-append">
														<a href="#" class="btn btn-default" v-on:click="(event) => deductQty(event, order.id)"><i class="fa fa-minus"></i></a>
													</div>
													<input type="text" v-model="order.quantity" class="form-control" />
													<div class="input-group-prepend">
														<a href="#" class="btn btn-default" v-on:click="(event) => addQty(event, order.id)"><i class="fa fa-plus"></i></a>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="pos-remove-confirmation" v-if="order.confirmation">
	...
	<a href="#" class="pos-mobile-sidebar-toggler" v-on:click="toggleMobileSidebar()">
		<Icon class="iconify display-6" icon="solar:bag-smile-bold-duotone" />
