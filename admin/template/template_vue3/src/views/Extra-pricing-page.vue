				...
				<div class="row mb-n3">
					<div class="col-lg-6">
						<div class="d-flex align-items-center mb-3">
							<Icon class="iconify fs-30px text-theme" icon="solar:cup-star-bold-duotone" />
							<div class="flex-1 ps-2 fs-13px fw-bold">
								Robust Performance
							</div>
						</div>
						<div class="d-flex align-items-center mb-3">
							<Icon class="iconify fs-30px text-theme" icon="solar:cpu-bolt-bold-duotone" />
							<div class="flex-1 ps-2 fs-13px fw-bold">
								Scalability Options
							</div>
						</div>
						<div class="d-flex align-items-center mb-3">
							<Icon class="iconify fs-30px text-theme" icon="solar:shield-bold-duotone" />
							<div class="flex-1 ps-2 fs-13px fw-bold">
								Security First
							</div>
						</div>
						<div class="d-flex align-items-center mb-3">
							<Icon class="iconify fs-30px text-theme" icon="solar:headphones-round-sound-bold-duotone" />
							<div class="flex-1 ps-2 fs-13px fw-bold">
								24/7 Support
							</div>
						</div>
					...
					<div class="col-lg-6">
						<div class="d-flex align-items-center mb-3">
							<Icon class="iconify fs-30px text-theme" icon="solar:monitor-smartphone-bold-duotone" />
							<div class="flex-1 ps-2 fs-13px fw-bold">
								User-Friendly Control Panel
							</div>
						</div>
						<div class="d-flex align-items-center mb-3">
							<Icon class="iconify fs-30px text-theme" icon="solar:mouse-bold-duotone" />
							<div class="flex-1 ps-2 fs-13px fw-bold">
								One-Click Installations
							</div>
						</div>
						<div class="d-flex align-items-center mb-3">
							<Icon class="iconify fs-30px text-theme" icon="solar:gift-bold-duotone" />
							<div class="flex-1 ps-2 fs-13px fw-bold">
								Value-Added Features
							</div>
						</div>
						<div class="d-flex align-items-center mb-3">
							<Icon class="iconify fs-30px text-theme" icon="solar:dollar-bold-duotone" />
							<div class="flex-1 ps-2 fs-13px fw-bold">
			...
			<div class="card border-0 rounded-4 h-100">
				<div class="card-body fs-14px p-30px d-flex flex-column">
					<div class="d-flex align-items-center">
						...
						<div>
							<Icon class="iconify display-4 text-theme rounded-3" icon="solar:usb-bold-duotone" />
						</div>
					</div>
					<hr class="my-4" />
			...
			<div class="card border-0 rounded-4 h-100">
				<div class="card-body fs-14px p-30px d-flex flex-column">
					<div class="d-flex align-items-center">
						...
						<div>
							<Icon class="iconify display-4 text-theme rounded-3" icon="solar:map-arrow-up-bold-duotone" />
						</div>
					</div>
					<hr class="my-4" />
					<div class="mb-5 text-body text-opacity-75 flex-1">
			...
			<div class="card border-0 rounded-4 shadow-lg bg-gradient-blue-indigo text-white h-100">
				<div class="card-body fs-15px p-30px h-100 d-flex flex-column">
					<div class="d-flex align-items-center">
						...
						<div>
							<Icon class="iconify display-3 text-black text-opacity-50 rounded-3" icon="solar:cup-first-bold-duotone" />
						</div>
					</div>
					<hr class="my-4" />
			...
			<div class="card border-0 rounded-4 h-100">
				<div class="card-body fs-14px p-30px d-flex flex-column">
					<div class="d-flex align-items-center">
						...
						<div>
							<Icon class="iconify display-4 text-theme rounded-3" icon="solar:buildings-bold-duotone" />
						</div>
					</div>
					<hr class="my-4" />
					<div class="mb-5 text-body text-opacity-75 flex-1">
