		...
		<div class="col-xl-8" id="bsSpyContent">
			...
			<div id="general" class="mb-4 pb-3">
				<h4 class="d-flex align-items-center mb-2">
					<Icon class="iconify fs-24px me-2 text-body text-opacity-75 my-n1" icon="solar:user-bold-duotone" /> General
				</h4>
			...
			<div id="notifications" class="mb-4 pb-3">
				<h4 class="d-flex align-items-center mb-2 mt-3">
					<Icon class="iconify fs-24px me-2 text-body text-opacity-75 my-n1" icon="solar:bell-bold-duotone" /> 
					Notifications
				</h4>
			...
			<div id="privacyAndSecurity" class="mb-4 pb-3">
				<h4 class="d-flex align-items-center mb-2 mt-3">
					<Icon class="iconify fs-24px me-2 text-body text-opacity-75 my-n1" icon="solar:lock-password-bold-duotone" /> 
			...
			<div id="payment" class="mb-4 pb-3">
				<h4 class="d-flex align-items-center mb-2 mt-3">
					<Icon class="iconify fs-24px me-2 text-body text-opacity-75 my-n1" icon="solar:bag-4-bold-duotone" /> 
					Payment
				</h4>
			...
			<div id="shipping" class="mb-4 pb-3">
				<h4 class="d-flex align-items-center mb-2 mt-3">
					<Icon class="iconify fs-24px me-2 text-body text-opacity-75 my-n1" icon="solar:box-bold-duotone" /> 
					Shipping
				</h4>
			...
			<div id="mediaAndFiles" class="mb-4 pb-3">
				<h4 class="d-flex align-items-center mb-2 mt-3">
					<Icon class="iconify fs-24px me-2 text-body text-opacity-75 my-n1" icon="solar:camera-bold-duotone" /> 
					Media and Files
				</h4>
			...
			<div id="languages" class="mb-4 pb-3">
				<h4 class="d-flex align-items-center mb-2 mt-3">
					<Icon class="iconify fs-24px me-2 text-body text-opacity-75 my-n1" icon="solar:globus-bold-duotone" /> 
					Languages
				</h4>
			...
			<div id="system" class="mb-4 pb-3">
				<h4 class="d-flex align-items-center mb-2 mt-3">
					<Icon class="iconify fs-24px me-2 text-body text-opacity-75 my-n1" icon="solar:ssd-round-bold-duotone" /> 
					System
				</h4>
			...
			<div id="resetSettings" class="mb-4 pb-3">
				<h4 class="d-flex align-items-center mb-2 mt-3">
					<Icon class="iconify fs-24px me-2 text-body text-opacity-75 my-n1" icon="solar:restart-bold-duotone" /> 
					Reset settings
				</h4>
