							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<router-link to="/extra/product-details" class="text-dark text-decoration-none">Force Majeure White T Shirt</router-link>
										</div>
									</div>
								</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<router-link to="/extra/product-details" class="text-dark text-decoration-none">Eco-friendly fashion, organic cotton, slow fashion polo shirts</router-link>
										</div>
									</div>
								</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<router-link to="/extra/product-details" class="text-dark text-decoration-none">Nike Shoes (Red Color)</router-link>
										</div>
									</div>
								</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<router-link to="/extra/product-details" class="text-dark text-decoration-none">Nike Air Max (Blue Color)</router-link>
										</div>
									</div>
								</td>
								<td class="align-middle">19 in stock for 1 variants</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<router-link to="/extra/product-details" class="text-dark text-decoration-none">Skate Sneaker (Orange Color)</router-link>
										</div>
									</div>
								</td>
								<td class="align-middle">19 in stock for 1 variants</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<router-link to="/extra/product-details" class="text-dark text-decoration-none">Teen Fashion T-shirt (Black)</router-link>
										</div>
									</div>
								</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<router-link to="/extra/product-details" class="text-dark text-decoration-none">Levis Blue Jeans</router-link>
										</div>
									</div>
								</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<router-link to="/extra/product-details" class="text-dark text-decoration-none">Boots (White Color)</router-link>
										</div>
									</div>
								</td>
								<td class="align-middle">19 in stock for 1 variants</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<router-link to="/extra/product-details" class="text-dark text-decoration-none">Hiking Boots</router-link>
										</div>
									</div>
								</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										...
										<div class="ms-3">
											<router-link to="/extra/product-details" class="text-dark text-decoration-none">Dress (Pink)</router-link>
										</div>
									</div>
								</td>
