	...
	<div class="messenger" id="messenger">
		<div class="messenger-menu">
			...
			<div class="messenger-menu-item active">
				<a href="#" class="messenger-menu-link">
					<Icon class="iconify fs-30px" icon="solar:dialog-2-bold-duotone" />
				</a>
			</div>
			<div class="messenger-menu-item">
				<a href="#" class="messenger-menu-link">
					<Icon class="iconify fs-30px" icon="solar:notebook-bold-duotone" />
				</a>
			</div>
			<div class="messenger-menu-item">
				<a href="#" class="messenger-menu-link">
					<Icon class="iconify fs-30px" icon="solar:box-minimalistic-bold-duotone" />
				</a>
			</div>
			<div class="messenger-menu-item">
				<a href="#" class="messenger-menu-link">
					<Icon class="iconify fs-30px" icon="solar:folder-with-files-bold-duotone" />
				</a>
			</div>
			<div class="messenger-menu-item">
				<a href="#" class="messenger-menu-link">
					<Icon class="iconify fs-30px" icon="solar:clapperboard-play-bold-duotone" />
				</a>
			</div>
			<div class="messenger-menu-item">
				<a href="#" class="messenger-menu-link">
					<Icon class="iconify fs-30px" icon="solar:settings-bold-duotone" />
				</a>
			</div>
		</div>
				...
				<perfect-scrollbar class="h-100">
					<div class="messenger-chat-list">
						...
						<div class="messenger-chat-item">
							<a href="javascript:;" class="messenger-chat-link" data-toggle-class="messenger-chat-content-mobile-toggled" data-target="#messenger">
								<div class="messenger-chat-media bg-lime-900 text-lime">
									<Icon class="iconify" icon="solar:book-bold-duotone" />
								</div>
								<div class="messenger-chat-content">
									<div class="messenger-chat-title">
						...
						<div class="messenger-chat-item">
							<a href="javascript:;" class="messenger-chat-link" data-toggle-class="messenger-chat-content-mobile-toggled" data-target="#messenger">
								<div class="messenger-chat-media bg-orange text-orange-900">
									<Icon class="iconify" icon="solar:oven-mitts-bold-duotone" />
								</div>
								<div class="messenger-chat-content">
									<div class="messenger-chat-title">
						...
						<div class="messenger-chat-item">
							<a href="javascript:;" class="messenger-chat-link" data-toggle-class="messenger-chat-content-mobile-toggled" data-target="#messenger">
								<div class="messenger-chat-media bg-blue-900 text-blue">
									<Icon class="iconify" icon="solar:gamepad-charge-bold-duotone" />
								</div>
								<div class="messenger-chat-content">
									<div class="messenger-chat-title">
										<div>Gaming Crew</div>
						...
						<div class="messenger-chat-item">
							<a href="javascript:;" class="messenger-chat-link" data-toggle-class="messenger-chat-content-mobile-toggled" data-target="#messenger">
								<div class="messenger-chat-media">
									<Icon class="iconify text-red-600" icon="solar:calendar-bold-duotone" />
								</div>
								<div class="messenger-chat-content">
									<div class="messenger-chat-title">
						...
						<div class="messenger-chat-item">
							<a href="javascript:;" class="messenger-chat-link" data-toggle-class="messenger-chat-content-mobile-toggled" data-target="#messenger">
								<div class="messenger-chat-media">
									<Icon class="iconify" icon="solar:clipboard-list-bold-duotone" />
								</div>
								<div class="messenger-chat-content">
									<div class="messenger-chat-title">
						...
						<div class="messenger-chat-item">
							<a href="javascript:;" class="messenger-chat-link" data-toggle-class="messenger-chat-content-mobile-toggled" data-target="#messenger">
								<div class="messenger-chat-media">
									<Icon class="iconify" icon="solar:bicycling-bold-duotone" />
								</div>
								<div class="messenger-chat-content">
									<div class="messenger-chat-title">
		...
		<div class="messenger-content">
			<div class="widget-chat">
				...
				<perfect-scrollbar class="widget-chat-body">
				...
				<div class="widget-chat-input">
					<div class="widget-chat-toolbar">
						...
						<a href="#" class="widget-chat-toolbar-link">
							<Icon class="iconify fs-26px" icon="solar:folder-with-files-outline" />
						</a>
						<a href="#" class="widget-chat-toolbar-link">
							<Icon class="iconify fs-26px" icon="solar:scissors-square-outline" />
						</a>
						<a href="#" class="widget-chat-toolbar-link">
							<Icon class="iconify fs-26px" icon="solar:chat-round-dots-outline" />
						</a>
						<a href="#" class="widget-chat-toolbar-link ms-auto">
							<Icon class="iconify fs-26px" icon="solar:phone-calling-outline" />
						</a>
						<a href="#" class="widget-chat-toolbar-link">
							<Icon class="iconify fs-26px" icon="solar:videocamera-record-outline" />
						</a>
					</div>
