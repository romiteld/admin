	...
	<div class="row">
		...
		<div class="col-xl-6">
			...
			<div class="panel panel-inverse" data-sortable-id="flot-chart-1">
				...
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/chart-flot/code-1.json"></code></pre>
				</div>
			</div>
			<!-- END panel -->
		</div>
		...
		<div class="col-xl-6">
			...
			<div class="panel panel-inverse" data-sortable-id="flot-chart-2">
				...
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/chart-flot/code-2.json"></code></pre>
				</div>
			</div>
			<!-- END panel -->
		</div>
	...
	<div class="row">
		...
		<div class="col-xl-6">
			...
			<div class="panel panel-inverse" data-sortable-id="flot-chart-3">
				...
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/chart-flot/code-3.json"></code></pre>
				</div>
			</div>
			<!-- END panel -->
		</div>
		...
		<div class="col-xl-6">
			...
			<div class="panel panel-inverse" data-sortable-id="flot-chart-4">
				...
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/chart-flot/code-4.json"></code></pre>
				</div>
			</div>
			<!-- END panel -->
		</div>
	...
	<div class="row">
		...
		<div class="col-xl-6">
			...
			<div class="panel panel-inverse" data-sortable-id="flot-chart-5">
				...
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/chart-flot/code-5.json"></code></pre>
				</div>
			</div>
			<!-- END panel -->
		</div>
		...
		<div class="col-xl-6">
			...
			<div class="panel panel-inverse" data-sortable-id="flot-chart-6">
				...
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/chart-flot/code-6.json"></code></pre>
				</div>
			</div>
			<!-- END panel -->
		</div>
	...
	<div class="row">
		...
		<div class="col-xl-6">
			...
			<div class="panel panel-inverse" data-sortable-id="flot-chart-7">
				...
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/chart-flot/code-7.json"></code></pre>
				</div>
			</div>
			<!-- END panel -->
		</div>
		...
		<div class="col-xl-6">
			...
			<div class="panel panel-inverse" data-sortable-id="flot-chart-8">
				...
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/chart-flot/code-8.json"></code></pre>
				</div>
			</div>
			<!-- END panel -->
		</div>
