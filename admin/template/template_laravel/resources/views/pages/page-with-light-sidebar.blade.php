@extends('layouts.default', ['appSidebarLight' => true, 'appHeaderInverse' => true])
...
@section('content')
	...
	<div class="panel panel-inverse">
		...
		<div class="hljs-wrapper">
			<pre><code class="html" data-url="/assets/data/page-with-light-sidebar/code-1.json"></code></pre>
		</div>
	</div>
	<!-- END panel -->
@endsection
