...
@section('content')
	...
	<div class="pos pos-with-header pos-with-sidebar" id="pos">
		...
		<div class="pos-header">
			<div class="logo">
				<a href="#pages/pos_counter_checkout.html" data-toggle="ajax">
			...
			<div class="nav">
				<div class="nav-item">
					<a href="#pages/pos_kitchen_order.html" data-toggle="ajax" class="nav-link">
						<i class="far fa-clock nav-icon"></i>
					</a>
				</div>
				<div class="nav-item">
					<a href="#pages/pos_table_booking.html" data-toggle="ajax" class="nav-link">
						<i class="far fa-calendar-check nav-icon"></i>
					</a>
				</div>
				<div class="nav-item">
					<a href="#pages/pos_menu_stock.html" data-toggle="ajax" class="nav-link">
