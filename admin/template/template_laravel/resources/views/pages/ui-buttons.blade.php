	...
	<div class="row">
		...
		<div class="col-xl-6">
			...
			<div class="panel panel-inverse" data-sortable-id="ui-buttons-1">
				...
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/ui-buttons/code-1.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
		...
		<div class="col-xl-6">
			...
			<div class="panel panel-inverse" data-sortable-id="ui-buttons-2">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/ui-buttons/code-2.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
	...
	<div class="row">
		...
		<div class="col-xl-6">
			...
			<div class="panel panel-inverse" data-sortable-id="ui-buttons-3">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/ui-buttons/code-3.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
		...
		<div class="col-xl-6">
			...
			<div class="panel panel-inverse" data-sortable-id="ui-buttons-4">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/ui-buttons/code-4.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
	...
	<div class="row">
		...
		<div class="col-xl-6">
			...
			<div class="panel panel-inverse" data-sortable-id="ui-buttons-5">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/ui-buttons/code-5.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
		...
		<div class="col-xl-6">
			...
			<div class="panel panel-inverse" data-sortable-id="ui-buttons-6">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/ui-buttons/code-6.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
		...
		<div class="col-xl-6">
			...
			<div class="panel panel-inverse" data-sortable-id="ui-buttons-7">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/ui-buttons/code-7.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
		...
		<div class="col-xl-6">
			...
			<div class="panel panel-inverse" data-sortable-id="ui-buttons-8">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/ui-buttons/code-8.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
