			...
			<div class="card border-0 rounded-4 h-100">
				<div class="card-body fs-14px p-30px d-flex flex-column">
					<div class="d-flex align-items-center">
						...
						<div>
							<span class="iconify display-4 text-theme rounded-3" data-icon="solar:usb-bold-duotone"></span>
						</div>
					</div>
					<hr class="my-4" />
			...
			<div class="card border-0 rounded-4 h-100">
				<div class="card-body fs-14px p-30px d-flex flex-column">
					<div class="d-flex align-items-center">
						...
						<div>
							<span class="iconify display-4 text-theme rounded-3" data-icon="solar:map-arrow-up-bold-duotone"></span>
						</div>
					</div>
					<hr class="my-4" />
					<div class="mb-5 text-body text-opacity-75 flex-1">
			...
			<div class="card border-0 rounded-4 h-100">
				<div class="card-body fs-14px p-30px d-flex flex-column">
					<div class="d-flex align-items-center">
						...
						<div>
							<span class="iconify display-4 text-theme rounded-3" data-icon="solar:buildings-bold-duotone"></span>
						</div>
					</div>
					<hr class="my-4" />
					<div class="mb-5 text-body text-opacity-75 flex-1">
