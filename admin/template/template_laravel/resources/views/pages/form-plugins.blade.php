	...
	<div class="row">
		...
		<div class="col-xl-6">
			...
			<div class="panel panel-inverse" data-sortable-id="form-plugins-1">
				...
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/form-plugins/code-1.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
			...
			<div class="panel panel-inverse" data-sortable-id="form-plugins-2">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/form-plugins/code-2.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
			...
			<div class="panel panel-inverse" data-sortable-id="form-plugins-3">
				...
				<div class="panel-body p-0">
					<form class="form-horizontal form-bordered">
						<div class="form-group row">
							...
							<div class="col-lg-8">
								<input type="text" class="form-control" id="datepicker-default" placeholder="Select Date" value="04/1/2023" />
							</div>
						</div>
						<div class="form-group row">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/form-plugins/code-3.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
			...
			<div class="panel panel-inverse" data-sortable-id="form-plugins-4">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/form-plugins/code-4.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
			...
			<div class="panel panel-inverse" data-sortable-id="form-plugins-5">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/form-plugins/code-5.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
		...
		<div class="col-xl-6">
			...
			<div class="panel panel-inverse" data-sortable-id="form-plugins-6">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/form-plugins/code-6.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
			...
			<div class="panel panel-inverse" data-sortable-id="form-plugins-7">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/form-plugins/code-7.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
			...
			<div class="panel panel-inverse" data-sortable-id="form-plugins-8">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/form-plugins/code-8.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
			...
			<div class="panel panel-inverse" data-sortable-id="form-plugins-9">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/form-plugins/code-9.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
			...
			<div class="panel panel-inverse" data-sortable-id="form-plugins-10">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/form-plugins/code-10.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
			...
			<div class="panel panel-inverse" data-sortable-id="form-plugins-11">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/form-plugins/code-11.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
