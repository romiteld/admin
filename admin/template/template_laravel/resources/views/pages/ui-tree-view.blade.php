	...
	<div class="row">
		...
		<div class="col-xl-6">
			...
			<div class="panel panel-inverse" data-sortable-id="tree-view-1">
				...
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/ui-tree/code-1.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
		...
		<div class="col-xl-6">
			...
			<div class="panel panel-inverse" data-sortable-id="tree-view-2">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/ui-tree/code-2.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
	...
	<div class="row">
		...
		<div class="col-xl-6">
			...
			<div class="panel panel-inverse" data-sortable-id="tree-view-4">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/ui-tree/code-4.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
