	...
	<div class="row">
		...
		<div class="col-xl-6">
			...
			<div class="hljs-wrapper rounded-0 rounded-bottom mb-4">
				<pre><code class="html" data-url="/assets/data/ui-tabs-accordions/code-1.json"></code></pre>
			</div>
			<!-- END hljs-wrapper -->
			...
			<!-- BEGIN hljs-wrapper -->
			<div class="hljs-wrapper rounded-0 rounded-bottom mb-4">
				<pre><code class="html" data-url="/assets/data/ui-tabs-accordions/code-2.json"></code></pre>
			</div>
			<!-- END hljs-wrapper -->
		</div>
		<!-- END col-6 -->
		...
		<div class="col-xl-6">
			...
			<div class="accordion" id="accordion">
				...
				<div class="hljs-wrapper rounded-0 rounded-bottom m-0">
					<pre><code class="html" data-url="/assets/data/ui-tabs-accordions/code-3.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END #accordion -->
