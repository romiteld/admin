...
@section('content')
	...
	<div class="panel panel-inverse" data-sortable-id="ui-buttons-8">
		...
		<div class="hljs-wrapper">
			<pre><code class="html" data-url="/assets/data/ui-tour/code-1.json"></code></pre>
		</div>
		<!-- END hljs-wrapper -->
	</div>
	...
	<div class="row">
		...
		<div class="col-lg-4">
			...
			<div class="panel">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/ui-tour/code-2.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
		...
		<div class="col-lg-4">
			...
			<div class="panel" data-intro="Intro.js has many examples. Browse this section to find out more." data-step="4">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/ui-tour/code-3.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
		...
		<div class="col-lg-4">
			...
			<div class="panel">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/ui-tour/code-4.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
