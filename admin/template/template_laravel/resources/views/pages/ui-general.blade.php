	...
	<div class="row">
		...
		<div class="col-xl-6">
			...
			<div class="panel panel-inverse" data-sortable-id="ui-general-1">
				...
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/ui-general/code-1.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
			...
			<div class="panel panel-inverse" data-sortable-id="ui-general-2">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/ui-general/code-2.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
			...
			<div class="panel panel-inverse" data-sortable-id="ui-general-3">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/ui-general/code-3.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
		...
		<div class="col-xl-6">
			...
			<div class="panel panel-inverse" data-sortable-id="ui-general-4">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/ui-general/code-4.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
			...
			<div class="panel panel-inverse" data-sortable-id="ui-general-5">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/ui-general/code-5.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
			...
			<div class="panel panel-inverse" data-sortable-id="ui-general-6">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/ui-general/code-6.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
